...
#pragma region Windows Form Designer generated code
		...
		double number1 = 0.0;//store the first number input
		double number2 = 0.0;//store the second number input
		double result = 0.0;//store the results of calculator
		char operators = ' ';// store the last operator
		bool num_input = false;//a flag to make sure the number was input before the operators
		
		
#pragma endregion
		//button1 
		//when click stroe the 1 to the textBox1
		//and change the number input as true make sure there is not operator without number
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
			 ...
			 //button10
			 //when click stroe the 0 to the textBox1
			 //and change the number input as true make sure there is not operator without number
	private: System::Void button10_Click(System::Object^  sender, System::EventArgs^  e) {
			 ...
			 //button2
			 //when click stroe the 2 to the textBox1
			 //and change the number input as true make sure there is not operator without number
	private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e) {
			 ...
			 //button3
			 //when click stroe the 3 to the textBox1
			 //and change the number input as true make sure there is not operator without number
	private: System::Void button3_Click(System::Object^  sender, System::EventArgs^  e) {
			 ...
			 //button14
			 //when click stroe the 4 to the textBox1
			 //and change the number input as true make sure there is not operator without number
	private: System::Void button4_Click(System::Object^  sender, System::EventArgs^  e) {
			 ...
			 //button5
			 //when click stroe the 5 to the textBox1
			 //and change the number input as true make sure there is not operator without number
	private: System::Void button5_Click(System::Object^  sender, System::EventArgs^  e) {
			 ...
			 //button6
			 //when click stroe 6 to the textBox1
			 //and change the number input as true make sure there is not operator without number
	private: System::Void button6_Click(System::Object^  sender, System::EventArgs^  e) {
			 ...
			 //button7
			 //when click stroe 7 to the textBox1
			 //and change the number input as true make sure there is not operator without number
	private: System::Void button7_Click(System::Object^  sender, System::EventArgs^  e) {
			 ...
			 //button8
			 //when click stroe 8 to the textBox1
			 //and change the number input as true make sure there is not operator without number
	private: System::Void button8_Click(System::Object^  sender, System::EventArgs^  e) {
			 ...
			 //button19
			 //when click stroe 9 to the textBox1
			 //and change the number input as true make sure there is not operator without number
	private: System::Void button9_Click_1(System::Object^  sender, System::EventArgs^  e) {
			 ...
			 //button11
			 //when click, clear textBox1 to zero
			 //and change the number input as true make sure there is not operator without number
...
//button14
//when clicking, operate the mutiplication
// if there is another operator before it, store the result of the first operator as the first number
	private: System::Void button14_Click(System::Object^  sender, System::EventArgs^  e){
				 if (num_input == false){
					 label1->Text = "ERROR";
				 }
				 else{//if the operator is the first operator
					 if (operators == ' ' ){
					 ...
					 else {//if the operator is the second operator
						 number2 = Convert::ToDouble(textBox1->Text);
						 //finish the first calculation and store the result to number 1
						 if (operators == '*'){
			 ...
			 //button12
			 //when clicking, finish the calculation and print the result on label1
			 // and reset number input and operator
	...
	private: System::Void button12_Click(System::Object^  sender, System::EventArgs^  e) {
			 ...
			 textBox1->Text = "";
			 // in case there is a denumenator is a zero
			 ...
			 //button15
			 //when clicking, operate the substraction
			 // if there is another operator before it, store the result of the first operator as the first number
	private: System::Void button15_Click(System::Object^  sender, System::EventArgs^  e) {
			 ...
			 //button16
			 //when clicking, operate the addition
			 // if there is another operator before it, store the result of the first operator as the first number
	private: System::Void button16_Click(System::Object^  sender, System::EventArgs^  e) {
			 ...
			 //button13
			 //when clicking, operate the division
			 // if there is another operator before it, store the result of the first operator as the first number
	private: System::Void button13_Click(System::Object^  sender, System::EventArgs^  e) {
			 ...
			 //button17
			 //when clicking, operate the inversion 1/x
			 // calculate the 1/x
	private: System::Void button17_Click(System::Object^  sender, System::EventArgs^  e) {
			 ...
			 //button 20
			 //when clicking, operate the dot, generate a decimal number
			 //add dot to the end of the number
	private: System::Void button20_Click(System::Object^  sender, System::EventArgs^  e) {
			 ...
			 //button 18
			 //apply calculation the square root of the input number
			 //print the result on lable1
private: System::Void button18_Click(System::Object^  sender, System::EventArgs^  e) {
		 ...
		 //button 19
		 //change the sign of the number negative to position, positive to negative
		 // leave 0 unchanged.
